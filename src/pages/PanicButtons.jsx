...
const BOTONES = [
  {
    tipo: 'red',
    emoji: '🔴',
    titulo: 'ATRAPADO / BAJO TIERRA',
    mensaje: 'ALERTA: Estoy atrapado o bajo tierra. Necesito rescate urgente.',
    color: '#C0392B',
    colorHover: '#a93226',
    smsTexto: '🔴 ALERTA EMERGENCIA SISMO',
    estado: 'ATRAPADO BAJO TIERRA',
  },
  {
    tipo: 'orange',
    emoji: '🟠',
    titulo: 'HERIDO / NECESITO AYUDA',
    mensaje: 'ALERTA: Estoy herido y necesito ayuda médica urgente.',
    color: '#E67E22',
    colorHover: '#ca6f1e',
    smsTexto: '🟠 ALERTA EMERGENCIA SISMO',
    estado: 'HERIDO, NECESITO AYUDA',
  },
  {
    tipo: 'green',
    emoji: '🟢',
